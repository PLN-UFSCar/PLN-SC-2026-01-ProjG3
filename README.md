...
Para a tarefa de Análise de Sentimento Baseada em Aspectos, adotamos duas estratégias:
1. Fine-tuning do BERTimbau, um modelo BERT pré treinado em um grande corpus de dados em portugês;
2. Estratégia baseada em regras, utilizando  VADER-PT
